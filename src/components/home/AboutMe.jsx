                ...
                <div className="container overflow-x-hidden">
                    <div className="AboutMe flex lg:flex-row flex-col justify-between">
                        <div className="aboutMeText">
                            ...
                            <p data-aos="fade-right" className='lg:text-[68px] text-[40px] font-soldier lg:leading-[72px] text-Primary font-medium lg:w-[370px] w-full'>Building Solutions <span data-aos="fade-left" className='text-coffee'> That Go </span>Beyond Code</p>
                            <div className='lg:text-[18px] text-[15px] font-poppins text-second font-normal lg:mt-10 lg:mb-0 mb-5 mt-5 lg:w-[370px] w-full'><BlurText text="Computer Science Engineer exploring software and data" delay={250} animateBy="words" direction="top" /></div>
                        </div>
                        <div>
                            <div className='lg:mb-[50px] mb-[24px] font-poppins lg:text-[32px] text-[16px] font-medium text-Primary lg:w-[700px] w-[100%] overflow-hidden '><BlurText text="I focus on writing clean code, solving problems, and learning modern technologies in software and data analytics." delay={150} animateBy="words" direction="top" /></div>
