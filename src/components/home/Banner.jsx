...
import PortfolioPic from "../../assets/images/ansh_photo.png"
// -----Animation Npm 
        ...
        <div className="container">
          <div className='flex justify-between items-start md:flex-nowrap flex-wrap gap-10 lg:gap-0'>
            <div className="bannerText" >
              ...
              <h1 data-aos="fade-right" data-aos-duration="1500" data-aos-delay="1000" data-aos-easing="ease-in-sine" className='font-poppins text-Primary text-[38px] lg:text-[68px] font-medium lg:mt-2 mt-4'>Hi, i'm <span className='text-[#BF4A1A]'>Ansh</span></h1>
              {/* -----animated Text------- */}
...
/>
              ...
              <div className='mt-6 flex items-center gap-3'>
                <Magnet padding={10} disabled={false} magnetStrength={5}>
                  <div data-aos="fade-right" data-aos-duration="2600" data-aos-delay="3000" data-aos-easing="ease-in-sine">
                    <Link to={'/contact'}  className='ContactButton transition-trigger px-[24px] py-[8px] font-poppins font-medium lg:text-base text-sm text-Primary hover-this'>CONTACT</Link>
                  </div>
                </Magnet>
                <Magnet padding={10} disabled={false} magnetStrength={5}>
                <a
  ...
  className='DownloadCv px-[24px] py-[8px] font-poppins font-medium text-Primary text-sm lg:py-[8px] lg:text-base hover-this'
>
  <span>DOWNLOAD RESUME</span>
    ...
    <a
      ...
      data-aos-delay="3000"
      data-aos-easing="ease-in-sine"
      className='DownloadCv px-[24px] py-[8px] font-poppins font-medium text-Primary text-sm lg:text-base hover-this'
    >
              ...
              <div className='mt-10 flex items-center gap-7'>
                ...
                <Magnet padding={20} disabled={false} magnetStrength={2}>
                  <div data-aos="fade-up" data-aos-duration="1400" data-aos-delay="1800" data-aos-easing="ease-in-sine" data-aos-offset="30">
                    <a target='_blank' href='https://www.instagram.com/_anshgupta_81/' aria-label="Visit my Instagram profile"><FaInstagram className='text-[18px] hover-brown' /></a>
                  </div>
                </Magnet>
                ...
                <Magnet padding={20} disabled={false} magnetStrength={2}>
                  <div data-aos="fade-left" data-aos-duration="2000" data-aos-delay="2000" data-aos-easing="ease-in-sine" data-aos-offset="30">
                    <a target='_blank' href='https://www.linkedin.com/in/ansh-gupta-19342b299/' aria-label="Visit my Linkedin profile"><FaLinkedinIn className='text-[18px] hover-brown'/></a>
                  </div>
                </Magnet>
              </div>
            </div>
