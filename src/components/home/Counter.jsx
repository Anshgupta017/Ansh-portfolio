        ...
        <section id='CounterBG' className='py-[25px] px-[30px] w-[50%] rounded-[10px] mb-20' ref={expandRef}>
            <div id="counterDiv" className='flex lg:flex-row lg:gap-0 gap-7 flex-col  lg:items-center justify-around'>
                <div className='flex items-center gap-5'>
                    ...
                    <div>
                        <h2 className='text-4xl text-brand font-poppins font-medium'><CountUp enableScrollSpy  end={10}  duration={5} />+</h2>
                ...
                <div className='flex items-center gap-5'>
  <h2 className='text-4xl text-brand font-poppins font-medium'>
    <CountUp end={5} enableScrollSpy duration={5} />+
  </h2>
  <p className='text-base text-[#E5E3DC] font-poppins font-medium'>
    Software Projects
  </p>
</div>
...
<div className='flex items-center gap-5'>
  <h2 className='text-4xl text-brand font-poppins font-medium'>
    <CountUp end={3} enableScrollSpy duration={5} />+
  </h2>
  <p className='text-base text-[#E5E3DC] font-poppins font-medium'>
