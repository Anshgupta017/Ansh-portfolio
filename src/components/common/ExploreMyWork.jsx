    ...
    <section id='ExploreMyWork' className='py-[50px] lg:mt-0 mt-20'>
        <div className="container">
            <div id="Explore-Row" className='flex lg:flex-row flex-col items-center justify-between'>
                {/* ---------------Right Side-------------- */}
                <div>
                    <div className='font-poppins text-Primary text-lg font-semibold uppercase'><ScrollFloat animationDuration={1} ease='back.inOut(2)' scrollStart='center bottom+=60%' scrollEnd='bottom bottom-=60%' stagger={0.03}>My Software and Data Projects</ScrollFloat></div>
